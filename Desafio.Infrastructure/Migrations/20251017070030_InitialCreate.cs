        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "VARCHAR(256) UNIQUE", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FavoriteList_Client_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Product", x => new { x.Id, x.FavoriteListId });
                    table.ForeignKey(
                        name: "FK_Product_FavoriteList_FavoriteListId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteList_ClientId",
                table: "FavoriteList",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_Product_FavoriteListId",
                table: "Product",
